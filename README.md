...
This template allows you to create a Virtual Network Manager Hub-and-Spoke connectivity configuration with one HUB virtual network and two SPOKE virtual networks, all in the same region.

`Tags: virtual network, network manager, hub and spoke, virtual machines`
